...
export default function Program(){
    ...
    <div className='b2b'>
        <div className='b2bline'>
            <div className='b2b_title'>
                우리 그룹에 딱 맞는 멘탈케어 솔루션을 찾고 있다면?
            </div>
            <div className='b2b_content'>
                기획부터 쉽고 편리한 운영보고까지.<br/>
                원하는 방식으로 도입하는 맞춤형 멘탈케어 솔루션
            </div>
            <button className='solbutton'>솔루션 도입/협업 문의하기</button>
        </div>

            <div className='b2bimg'></div>
    </div>
    <div className='cardList'>
        <div className='card'>
            <div className='card_title'>#나다움</div>
            <div className='card_cate'>나를 알아가는 방법</div>
        ...
        <div className='card'>
            <div className='card_title'>#인간관계</div>{ TfiApple }
            <div className='card_cate'>인간관계를 잘 맺는 사람이 되는 방법</div>
            <div className='card_content'>
        ...
        <div className='card'>
            <div className='card_title'>#멘탈관리</div>
            <div className='card_cate'>멘탈을 잘 관리하는 사람이 되는 방법</div>
            <div className='card_content'>
    ...
    <div className='cardList'>
    <div className='card'>
            <div className='card_title'>#계획력&실행력</div>
            <div className='card_cate'>바쁘기만한 계획이 아니라 성공하는 계획</div>
            <div className='card_content'>
        ...
        <div className='card'>
            <div className='card_title'>#성공과 리더쉽</div>
            <div className='card_cate'>진정한 성공과 셀프 리더쉽</div>
            <div className='card_content'>
        ...
        <div className='card'>
            <div className='card_title'>#동기부여</div>
            <div className='card_cate'>나만의 에너지를 찾는 동기부여 방법</div>
            <div className='card_content'>
